...
var UserService = /** @class */ (function () {
    ...
    UserService.prototype.getUsers = function (page, itemsPerPage, userParams, likesParam) {
        ...
        var myHeaders = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]().set('Authorization', 'Bearer ' + localStorage.getItem('token')); // create header object
        ...
        return this.http.get(this.baseUrl + 'users', { observe: 'response', params: params, headers: myHeaders })
    ...
    UserService.prototype.getMessages = function (id, page, itemsPerPage, messageContainer) {
        ...
        return this.http.get(this.baseUrl + 'users/' + id + '/messages', { observe: 'response', params: params, headers: myHeaders })
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(function (response) {
            paginatedResult.result = response.body;
            if (response.headers.get('Pagination') !== null) {
                paginatedResult.pagination = JSON.parse(response.headers.get('Pagination'));
    ...
    UserService.prototype.getMessageThread = function (id, recipientId) {
        return this.http.get(this.baseUrl + 'users/' + id + '/messages/thread/' + recipientId, httpOptions);
    };
...
var ListsResolver = /** @class */ (function () {
    ...
    ListsResolver.prototype.resolve = function (route) {
        var _this = this;
        return this.userService.getUsers(this.pageNumber, this.pageSize, null, this.likesParam).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["catchError"])(function (error) {
...
var MemberDetailResolver = /** @class */ (function () {
    ...
    MemberDetailResolver = __decorate([
        ...
        __metadata("design:paramtypes", [_Services_user_service__WEBPACK_IMPORTED_MODULE_2__["UserService"], _angular_router__WEBPACK_IMPORTED_MODULE_4__["Router"],
...
var MemberEditResolver = /** @class */ (function () {
    function MemberEditResolver(userService, authServive, router, alertfiy) {
        this.userService = userService;
        this.authServive = authServive;
        this.router = router;
        this.alertfiy = alertfiy;
    }
    MemberEditResolver.prototype.resolve = function (route) {
        ...
        return this.userService.getUser(this.authServive.decodedToken.nameid)
            ...
            _this.alertfiy.error('Problem retrieving your data: ' + error);
            _this.router.navigate(['/members']);
...
/* harmony import */ var _Services_auth_service__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! ./_Services/auth.service */ "./src/app/_Services/auth.service.ts");
...
/* harmony import */ var _resolvers_member_list_resolver___WEBPACK_IMPORTED_MODULE_27__ = __webpack_require__(/*! ./_resolvers/member-list.resolver. */ "./src/app/_resolvers/member-list.resolver..ts");
...
/* harmony import */ var _resolvers_member_detail_resolver__WEBPACK_IMPORTED_MODULE_29__ = __webpack_require__(/*! ./_resolvers/member-detail.resolver */ "./src/app/_resolvers/member-detail.resolver.ts");
    ...
    AppModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            ...
            imports: [
                ...
                _angular_router__WEBPACK_IMPORTED_MODULE_8__["RouterModule"].forRoot(_routes__WEBPACK_IMPORTED_MODULE_22__["appRoutes"]),
                ...
                _auth0_angular_jwt__WEBPACK_IMPORTED_MODULE_9__["JwtModule"].forRoot({
                    config: {
                        tokenGetter: function () { return localStorage.getItem('tokken'); },
            ...
            providers: [
                ...
                _resolvers_member_detail_resolver__WEBPACK_IMPORTED_MODULE_29__["MemberDetailResolver"],
                _resolvers_member_list_resolver___WEBPACK_IMPORTED_MODULE_27__["MemberListResolver"],
...
var MemberCardComponent = /** @class */ (function () {
    ...
    MemberCardComponent = __decorate([
        ...
        __metadata("design:paramtypes", [src_app_Services_auth_service__WEBPACK_IMPORTED_MODULE_2__["AuthService"], src_app_Services_user_service__WEBPACK_IMPORTED_MODULE_0__["UserService"], src_app_Services_alertify_service__WEBPACK_IMPORTED_MODULE_3__["AlertifyService"]])
    ], MemberCardComponent);
...
/* harmony import */ var ngx_gallery__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ngx-gallery */ "./node_modules/ngx-gallery/bundles/ngx-gallery.umd.js");
/* harmony import */ var ngx_gallery__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(ngx_gallery__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _Services_alertify_service__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./../../_Services/alertify.service */ "./src/app/_Services/alertify.service.ts");
/* harmony import */ var _Services_user_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./../../_Services/user.service */ "./src/app/_Services/user.service.ts");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/fesm5/router.js");
...
var MemberDetailComponent = /** @class */ (function () {
        ...
        this.galleryOptions = [
            {
                ...
                imagePercent: 100,
                thumbnailsColumns: 4,
                imageAnimation: ngx_gallery__WEBPACK_IMPORTED_MODULE_0__["NgxGalleryAnimation"].Slide,
                preview: false
            }
        ];
    ...
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_3__["ViewChild"])('memberTabs'),
...
var MemberEditComponent = /** @class */ (function () {
    ...
    MemberEditComponent.prototype.updateUser = function () {
        ...
        this.userService.updateUser(this.user.id, this.user).subscribe(function (next) {
            _this.editForm.reset(_this.user);
            _this.alertify.success('Profile updated succesfully');
        }, function (error) {
            console.log(error);
            _this.alertify.error(error);
        });
...
var PhotoEditorComponent = /** @class */ (function () {
    function PhotoEditorComponent(authService, userService, alertify) {
        ...
        this.userService = userService;
        this.alertify = alertify;
        this.getMemberPhotoChange = new _angular_core__WEBPACK_IMPORTED_MODULE_3__["EventEmitter"]();
    ...
    PhotoEditorComponent = __decorate([
        ...
        __metadata("design:paramtypes", [_Services_auth_service__WEBPACK_IMPORTED_MODULE_1__["AuthService"], src_app_Services_user_service__WEBPACK_IMPORTED_MODULE_5__["UserService"],
...
var MessagesComponent = /** @class */ (function () {
    ...
    MessagesComponent = __decorate([
        ...
        __metadata("design:paramtypes", [_Services_user_service__WEBPACK_IMPORTED_MODULE_2__["UserService"], _Services_auth_service__WEBPACK_IMPORTED_MODULE_4__["AuthService"],
            _angular_router__WEBPACK_IMPORTED_MODULE_1__["ActivatedRoute"], _Services_alertify_service__WEBPACK_IMPORTED_MODULE_3__["AlertifyService"]])
    ], MessagesComponent);
...
var NavComponent = /** @class */ (function () {
    ...
    NavComponent = __decorate([
        ...
        __metadata("design:paramtypes", [_Services_auth_service__WEBPACK_IMPORTED_MODULE_2__["AuthService"], _Services_alertify_service__WEBPACK_IMPORTED_MODULE_0__["AlertifyService"],
...
var RegisterComponent = /** @class */ (function () {
    ...
    RegisterComponent = __decorate([
        ...
        __metadata("design:paramtypes", [_Services_auth_service__WEBPACK_IMPORTED_MODULE_1__["AuthService"], _angular_router__WEBPACK_IMPORTED_MODULE_4__["Router"],
            _Services_alertify_service__WEBPACK_IMPORTED_MODULE_0__["AlertifyService"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormBuilder"]])
    ], RegisterComponent);
...
/* harmony import */ var _members_member_edit_member_edit_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./members/member-edit/member-edit.component */ "./src/app/members/member-edit/member-edit.component.ts");
/* harmony import */ var _resolvers_member_list_resolver___WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./_resolvers/member-list.resolver. */ "./src/app/_resolvers/member-list.resolver..ts");
...
/* harmony import */ var _members_member_detail_member_detail_component__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./members/member-detail/member-detail.component */ "./src/app/members/member-detail/member-detail.component.ts");
/* harmony import */ var _resolvers_member_detail_resolver__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./_resolvers/member-detail.resolver */ "./src/app/_resolvers/member-detail.resolver.ts");
...
var appRoutes = [
    { path: '', component: _home_home_component__WEBPACK_IMPORTED_MODULE_8__["HomeComponent"] },
    {
        ...
        children: [
            { path: 'members', component: _members_member_list_member_list_component__WEBPACK_IMPORTED_MODULE_7__["MemberListComponent"], resolve: { users: _resolvers_member_list_resolver___WEBPACK_IMPORTED_MODULE_4__["MemberListResolver"] } },
            { path: 'members/:id', component: _members_member_detail_member_detail_component__WEBPACK_IMPORTED_MODULE_10__["MemberDetailComponent"], resolve: { user: _resolvers_member_detail_resolver__WEBPACK_IMPORTED_MODULE_11__["MemberDetailResolver"] } },
            { path: 'member/edit', component: _members_member_edit_member_edit_component__WEBPACK_IMPORTED_MODULE_3__["MemberEditComponent"],
                resolve: { user: _resolvers_member_edit_resolver__WEBPACK_IMPORTED_MODULE_2__["MemberEditResolver"] }, canDeactivate: [_guards_prevent_unsaved_changes_guard__WEBPACK_IMPORTED_MODULE_12__["PreventUnsavedChanges"]] },
            { path: 'messages', component: _messages_messages_component__WEBPACK_IMPORTED_MODULE_9__["MessagesComponent"], resolve: { messages: _resolvers_messages_resolver__WEBPACK_IMPORTED_MODULE_0__["MessagesResolver"] } },
            { path: 'lists', component: _lists_lists_component__WEBPACK_IMPORTED_MODULE_6__["ListsComponent"], resolve: { users: _resolvers_lists_resolver__WEBPACK_IMPORTED_MODULE_1__["ListsResolver"] } }
        ]
    },
...
module.exports = __webpack_require__(/*! E:\Projects\Prototypes\DatingApp\DatingApp-SPA\src\main.ts */"./src/main.ts");
